...
//In the context of machine learning, ground truth refers to the true or correct output that a model is trying to predict.
ground_truth_files = {'train_dataset/tool_video_01.txt', 'train_dataset/tool_video_02.txt', 'train_dataset/tool_video_03.txt', 'train_dataset/tool_video_04.txt', ...
                    'train_dataset/tool_video_05.txt','train_dataset/tool_video_06.txt','train_dataset/tool_video_07.txt','train_dataset/tool_video_08.txt',...
                    'train_dataset/tool_video_09.txt','train_dataset/tool_video_10.txt'};
